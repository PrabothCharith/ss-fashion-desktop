...
public class AddNewCity extends javax.swing.JDialog {
     ...
     */
    public AddNewCity(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();
        loginValidate();
    ...
    public AddNewCity(GUI.AddNewBranch parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();
        loginValidate();
    ...
    public AddNewCity(GUI.AddNewCompany parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();
        loginValidate();
    ...
    public AddNewCity(GUI.AddNewEmployee parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();
        loginValidate();
    ...
    public AddNewCity(GUI.AddNewCustomer parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();
        loginValidate();
