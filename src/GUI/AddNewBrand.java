...
public class AddNewBrand extends javax.swing.JDialog {
    ...
    public AddNewBrand(AddNewProduct parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();loginValidate();
        this.anp = parent;
    ...
    public AddNewBrand(Management parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();loginValidate();
        this.m = parent;
