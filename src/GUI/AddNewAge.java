 ...
 * @author praboth
 */
public class AddNewAge extends javax.swing.JDialog {

    /**
     * Creates new form AddNewCategory
     */
    public AddNewAge(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();
        loginValidate();
    ...
    public AddNewAge(AddNewProduct parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();
        loginValidate();
    ...
    public AddNewAge(AddGRN parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();
        loginValidate();
    ...
    public AddNewAge(Management parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();
        loginValidate();
    ...
    private void initComponents() {
        ...
        setTitle("Add new Age");

        jLabel1.setText("Add age");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (name.isEmpty()) {
            ...
            try {
                ...
                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "This " + tableName + " range already exsist !", "Duplicate value", JOptionPane.WARNING_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddNewAge.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddNewAge dialog = new AddNewAge(new javax.swing.JFrame(), true);
