 ...
 * @author praboth
 */
public class AddNewMaterial extends javax.swing.JDialog {

    /**
     * Creates new form AddNewCategory
     */
    public AddNewMaterial(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();
        loginValidate();
    ...
    public AddNewMaterial(AddNewProduct parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();
        loginValidate();
    ...
    public AddNewMaterial(AddGRN parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();
        loginValidate();
    ...
    public void loadResult() {
        try {
            ...
            while (rs.next()) {
                Vector v = new Vector();
                v.add(rs.getString("material.id"));
    ...
    private void initComponents() {
        ...
        setTitle("Add new Material for Product");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddNewMaterial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddNewMaterial dialog = new AddNewMaterial(new javax.swing.JFrame(), true);
