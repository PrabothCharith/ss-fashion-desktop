 ...
 * @author praboth
 */
public class AddNewPaymentMethod extends javax.swing.JDialog {

    /**
     * Creates new form AddNewCategory
     */
    public AddNewPaymentMethod(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();loginValidate();
    }

    AddGRN agrn;

    public AddNewPaymentMethod(AddGRN parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();loginValidate();
        this.agrn = parent;
    ...
    public void loadResult() {
        try {
            ...
            while (rs.next()) {
                Vector v = new Vector();
                v.add(rs.getString("payment_type.id"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddNewPaymentMethod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddNewPaymentMethod dialog = new AddNewPaymentMethod(new javax.swing.JFrame(), true);
