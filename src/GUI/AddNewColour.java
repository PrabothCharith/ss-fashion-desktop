...
public class AddNewColour extends javax.swing.JDialog {
    ...
    public AddNewColour(AddNewProduct parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();
        loginValidate();
    ...
    public AddNewColour(AddGRN parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadResult();
        loginValidate();
    ...
    private void initComponents() {
        ...
        setTitle("Add new Colour for Product");

        jLabel1.setText("Add Colour");
